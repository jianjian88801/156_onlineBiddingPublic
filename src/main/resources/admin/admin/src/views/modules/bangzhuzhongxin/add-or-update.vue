<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="帮助标题" prop="bangzhubiaoti">
          <el-input v-model="ruleForm.bangzhubiaoti" 
              placeholder="帮助标题" clearable  :readonly="ro.bangzhubiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="帮助标题" prop="bangzhubiaoti">
              <el-input v-model="ruleForm.bangzhubiaoti" 
                placeholder="帮助标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="帮助分类" prop="bangzhufenlei">
          <el-select :disabled="ro.bangzhufenlei" v-model="ruleForm.bangzhufenlei" placeholder="请选择帮助分类">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="帮助分类" prop="bangzhufenlei">
	      <el-input v-model="ruleForm.bangzhufenlei"
                placeholder="帮助分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="资料简介" prop="ziliaojianjie">
          <el-input v-model="ruleForm.ziliaojianjie" 
              placeholder="资料简介" clearable  :readonly="ro.ziliaojianjie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="资料简介" prop="ziliaojianjie">
              <el-input v-model="ruleForm.ziliaojianjie" 
                placeholder="资料简介" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='bangzhubiaoti'){
            this.ruleForm.bangzhubiaoti = obj[o];
	    this.ro.bangzhubiaoti = true;
            continue;
          }
          if(o=='fengmian'){
	    ...
	    this.ro.fengmian = true;
          ...
          if(o=='bangzhufenlei'){
            this.ruleForm.bangzhufenlei = obj[o];
	    this.ro.bangzhufenlei = true;
            continue;
          }
          if(o=='ziliaojianjie'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `bangzhuzhongxin/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.bangzhuzhongxinCrossAddOrUpdateFlag = false;
						 this.parent.search();
