<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="招标分类" prop="zhaobiaofenlei">
          <el-input v-model="ruleForm.zhaobiaofenlei" 
              placeholder="招标分类" clearable  :readonly="ro.zhaobiaofenlei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="招标分类" prop="zhaobiaofenlei">
              <el-input v-model="ruleForm.zhaobiaofenlei" 
                placeholder="招标分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="招标单位" prop="zhaobiaodanwei">
          <el-input v-model="ruleForm.zhaobiaodanwei" 
              placeholder="招标单位" clearable  :readonly="ro.zhaobiaodanwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="招标单位" prop="zhaobiaodanwei">
              <el-input v-model="ruleForm.zhaobiaodanwei" 
                placeholder="招标单位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公示期" prop="gongshiqi">
          <el-input v-model="ruleForm.gongshiqi" 
              placeholder="公示期" clearable  :readonly="ro.gongshiqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公示期" prop="gongshiqi">
              <el-input v-model="ruleForm.gongshiqi" 
                placeholder="公示期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="中标候选人" prop="zhongbiaohouxuanren">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zhongbiaohouxuanren" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhongbiaohouxuanren" label="中标候选人" prop="zhongbiaohouxuanren">
                    <span v-html="ruleForm.zhongbiaohouxuanren"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	fengmian : false,
	zhaobiaofenlei : false,
	zhaobiaodanwei : false,
	gongshiqi : false,
	fabushijian : false,
	zhongbiaohouxuanren : false,
      },
      ruleForm: {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fengmian = true;
          ...
          if(o=='zhaobiaofenlei'){
            this.ruleForm.zhaobiaofenlei = obj[o];
	    this.ro.zhaobiaofenlei = true;
            continue;
          }
          if(o=='zhaobiaodanwei'){
	    ...
	    this.ro.zhaobiaodanwei = true;
          ...
          if(o=='gongshiqi'){
            this.ruleForm.gongshiqi = obj[o];
	    this.ro.gongshiqi = true;
            continue;
          }
          if(o=='fabushijian'){
	    ...
	    this.ro.fabushijian = true;
          ...
          if(o=='zhongbiaohouxuanren'){
            this.ruleForm.zhongbiaohouxuanren = obj[o];
	    this.ro.zhongbiaohouxuanren = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.zhongbiaohouxuanren = this.ruleForm.zhongbiaohouxuanren.replace(reg,'../../../springbootbtw32/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jieguogongshi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jieguogongshiCrossAddOrUpdateFlag = false;
						 this.parent.search();
